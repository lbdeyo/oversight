...
> = {
  ...
  "marcus-mcquirter": {
    name: "Marcus E. McQuirter",
    title: "Director",
    bio: "Marcus E. McQuirter M.A., Ph.D., Professor of Drama, received his BFA in Theatre Arts from Howard University in Washington, DC and an M.A. in Theatre from the University of North Texas. He earned a Ph.D. in Performance Studies from the University of Texas, Austin. He joined the Drama Department at ACC in 2006 where he has taught Voice, Acting, and *Introduction to Theater*.",
  },
  "natalie-george": {
    title: "Lighting Designer",
    bio: "Natalie George is an award winning lighting designer, producer, events manager, and artist based in Austin, TX. After studying Theater Arts at St. Edward's University, Natalie began to work as a freelance lighting designer and stage manager around Austin and beyond. Quickly her design work became her full-time focus, designing for Salvage Vanguard Theater, Rude Mechs, Mary Moody Northen Theater, The O'Neill Theater Center, and many more. In 2014 she founded Natalie George Productions, where she now works full-time as Executive Director. While she enjoys working throughout the US, her love of all things Austin keeps her rooted here and affords her the opportunity to use her many contacts and resources to collaborate on interesting projects as a lighting designer, technical consultant, or event producer.",
  },
  "robert-pierson": {
